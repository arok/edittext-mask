...
//					return false;
    ...
    public MaskedEditText(Context context, AttributeSet attrs) {
        ...
        prefillText = attributes.getString(R.styleable.MaskedEditText_prefill_text);
        ...
        super.setOnFocusChangeListener(new OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                ...
                if (hasFocus()) {
                    ...
                    if (prefillText != null && !prefillText.isEmpty() && rawText.length() == 0) {
                        setText(prefillText);
                        setSelection(prefillText.length() - 1);
                    } else {
                        MaskedEditText.this.setSelection(lastValidPosition());
                    }
                } else {
                    if (getRawText().equals(prefillText)) {
                        setText("");
                    }
                }
            }
